...
export default function Home() {
  return (
    ...
    <div className="absolute top-0 left-0 w-full h-full divide-y snap-y snap-mandatory overflow-y-scroll h">
      ...
      {/* splash page */}
      <main className="flex min-h-screen flex-col items-center justify-between p-24 bg-neutral-100 dark:bg-neutral-900 snap-center snap-always">
        ...
        <div className="mb-32 grid text-center lg:mb-0 lg:w-full lg:max-w-5xl lg:grid-cols-4 lg:text-left divide-x">
          ...
          <Link href="#poster" className="group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30">
      ...
      {/* poster page */}
      < main id="poster" className="flex min-h-screen flex-col items-center justify-between p-24 bg-neutral-200 dark:bg-neutral-800 snap-center snap-always" >
      ...
      {/* character page */}
      < main id="character" className="flex min-h-screen flex-col items-center justify-between p-24 bg-neutral-300 dark:bg-neutral-700 snap-center snap-always" >
            ...
            <CarouselContent className="-ml-4">
              ...
              <CarouselItem className="pl-4">
                <CharacterProfile name="Spoops"
                  full_title="God of Life and Death, Myrkul, Avatar of Ry-ann, Grandmaster Spoops The Crusader"
