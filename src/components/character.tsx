...
export function CharacterProfile({ name: rawName, full_title, class_name, subclass, background, description, race, alignment, level }: Character): JSX.Element {
    // Encode the name before passing it to any path/URL-based consumer
        ...
        <div className="flex flex-col justify-center items-center py-8 rounded-[20px] bg-gray-200 dark:bg-neutral-800 bg-clip-border shadow-3xl shadow-shadow-500 dark:text-white dark:shadow-none">
            <div className="relative flex lg:flex-col max-lg:flex-col items-center max-w-[95%] mx-auto pt-3">
                ...
                <div className="mt-2 mb-8 w-full text-left">
                    <h4 className="px-2 text-sm sm:text-xl font-bold text-gray-800 dark:text-gray-200 text-left sm:text-center">
                        {full_title}
                    </h4>
                    <p className="mt-2 px-2 text-sm sm:text-base text-left text-gray-800 dark:text-gray-200 hidden sm:block">
                        {description}
                    </p>
                </div>
                <div className="grid grid-cols-3 gap-1 sm:gap-2 px-2 w-full text-xs sm:text-sm">
                    <div className="flex flex-col items-start justify-center rounded-2xl bg-gray-100 dark:bg-neutral-700 bg-clip-border px-2 sm:px-3 py-1 sm:py-2 shadow-3xl shadow-shadow-500 dark:shadow-none">
                        <p className="text-[0.6rem] top-5 left-5 xs:text-xs sm:text-xs md:text-sm lg:text-base text-gray-600 dark:text-gray-300 leading-tight">CLASS</p>
                        <p className="text-[0.6rem] xs:text-xs sm:text-xs md:text-sm lg:text-base text-gray-700 dark:text-gray-100 leading-tight">
                            {class_name}
                        </p>
                    </div>

                    <div className="flex flex-col items-start justify-center rounded-2xl bg-gray-100 dark:bg-neutral-700 bg-clip-border px-2 sm:px-3 py-1 sm:py-2 shadow-3xl shadow-shadow-500 dark:shadow-none">
                        <p className="text-[0.6rem] top-5 left-5 xs:text-xs sm:text-xs md:text-sm lg:text-base text-gray-600 dark:text-gray-300 leading-tight">SUBCLASS</p>
                        <p className="text-[0.6rem] xs:text-xs sm:text-xs md:text-sm lg:text-base text-gray-700 dark:text-gray-100 leading-tight">
                            {subclass}
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col items-start justify-center rounded-2xl bg-gray-100 dark:bg-neutral-700 bg-clip-border px-2 sm:px-3 py-1 sm:py-2 shadow-3xl shadow-shadow-500 dark:shadow-none">
                        <p className="text-[0.6rem] top-5 left-5 xs:text-xs sm:text-xs md:text-sm lg:text-base text-gray-600 dark:text-gray-300 leading-tight">BACKGROUND</p>
                        <p className="text-[0.6rem] xs:text-xs sm:text-xs md:text-sm lg:text-base text-gray-700 dark:text-gray-100 leading-tight">
                            {background}
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col items-start justify-center rounded-2xl bg-gray-100 dark:bg-neutral-700 bg-clip-border px-2 sm:px-3 py-1 sm:py-2 shadow-3xl shadow-shadow-500 dark:shadow-none">
                        <p className="text-[0.6rem] top-5 left-5 xs:text-xs sm:text-xs md:text-sm lg:text-base text-gray-600 dark:text-gray-300 leading-tight">RACE</p>
                        <p className="text-[0.6rem] xs:text-xs sm:text-xs md:text-sm lg:text-base text-gray-700 dark:text-gray-100 leading-tight">
                            {race}
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col items-start justify-center rounded-2xl bg-gray-100 dark:bg-neutral-700 bg-clip-border px-2 sm:px-3 py-1 sm:py-2 shadow-3xl shadow-shadow-500 dark:shadow-none">
                        <p className="text-[0.6rem] top-5 left-5 xs:text-xs sm:text-xs md:text-sm lg:text-base text-gray-600 dark:text-gray-300 leading-tight">ALIGNMENT</p>
                        <p className="text-[0.6rem] xs:text-xs sm:text-xs md:text-sm lg:text-base font-medium text-gray-700 dark:text-gray-100 leading-tight">
                            {alignment}
                        </p>
                    </div>

                    <div className="flex flex-col items-start justify-center rounded-2xl bg-gray-100 dark:bg-neutral-700 bg-clip-border px-2 sm:px-3 py-1 sm:py-2 shadow-3xl shadow-shadow-500 dark:shadow-none">
                        <p className="text-[0.6rem] top-5 left-5 xs:text-xs sm:text-xs md:text-sm lg:text-base text-gray-600 dark:text-gray-300 leading-tight">LEVEL</p>
                        <p className="text-[0.6rem] xs:text-xs sm:text-xs md:text-sm lg:text-base font-medium text-gray-700 dark:text-gray-100 leading-tight">
                            {level}
                        </p>
                    </div>
            ...
            <CharacterHighlights name={safeName} />
